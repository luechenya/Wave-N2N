...
def main():
    ...
    model.load_state_dict(torch.load(os.path.join(opt.logdirdn, 'net_WINNet.pth')),strict=False)
    model.eval()
    ...
    for k_index in range(kernels.shape[1]):
        ...
        for f in files_source:
            ...
            while stdNv > stdNv_:
                ...
                print('xk %f, zk %f, std %f, tau %f,std_ %f' % (psnr_xd, psnr_x, stdNv, tau,stdNv_))
                i += 1
