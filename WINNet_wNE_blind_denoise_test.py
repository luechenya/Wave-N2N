...
def main():
    ...
    dnmodel.load_state_dict(torch.load(os.path.join(opt.logdirdn, 'net_WINNet.pth')),strict=False)
    nemodel.load_state_dict(torch.load(os.path.join(opt.logdirne, 'net_NENet.pth')),strict=False)
