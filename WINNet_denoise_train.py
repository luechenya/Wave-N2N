...
parser.add_argument("--batchSize", type=int, default=32, help="Training batch size")#32
parser.add_argument("--num_of_steps", type=int, default=4, help="Number of steps")#原来4
parser.add_argument("--num_of_layers", type=int, default=4, help="Number of layers")#原来4
...
parser.add_argument("--dnlayers", type=int, default=4, help="Number of denoising layers")#原来4
parser.add_argument("--epochs", type=int, default=50, help="Number of training epochs")
parser.add_argument("--milestone", type=int, default=35, help="When to decay learning rate; should be less than epochs")
parser.add_argument("--start_epoch", type=int, default=40, help="start epochs")
parser.add_argument("--lr", type=float, default=1e-3, help="Initial learning rate")
parser.add_argument("--decay_rate", type=float, default=0.1, help="decay rate")
parser.add_argument("--outf", type=str, default="logs", help='path of log files')
parser.add_argument("--mode", type=str, default="S", help='with known noise level (S) or blind training (B)')
parser.add_argument("--noiseL", type=float, default=25, help='noise level; ignored when mode=B')#25
#上面调参
...
def main():
    ...
    # handler = logging.FileHandler("/logs/"+opt.mode + "_TrainLog.txt", encoding="utf-8")
    # handler.setLevel(logging.INFO)
    # formatter = logging.Formatter('%(asctime)s - %(name)s - %(levelname)s - %(message)s')
    # handler.setFormatter(formatter)
    # logger.addHandler(handler)

    logger = get_logger('/Code/PyWorkspace/WINNet-main/logs/'+opt.mode+'_trainlog.txt')
    ...
    while epoch <= opt.epochs:
        ...
        ########################################################################################################
        # logger.info("epoch=%d" % epoch + ",loss=" + loss)
        logger.info('Epoch:[{}/{}]\t loss={:.5f}\t '.format(epoch, opt.epochs, floss))
        ########################################################################################################
